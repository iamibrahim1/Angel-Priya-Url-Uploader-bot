...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5762512638:AAH7h0Ewvpv0gvI0R7QGb0e7r_aA55lRJMQ")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 25184668))
    ...
    LAZY_DEVELOPER = set(int(x) for x in os.environ.get("LAZY_ADMIN", "5390385209").split())
